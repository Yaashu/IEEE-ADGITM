...
window.onload = fetchEventsFromAPI = async () => {
  ...
  const response = await fetch('https://certificate-generator-ieee.herokuapp.com/getAllEvents');
...
function submitDetails(){
  ...
  axios.post('https://certificate-generator-ieee.herokuapp.com/checkAuthenticity',{
    "name": name,
    "email": email,
    'eventID': event
  })
